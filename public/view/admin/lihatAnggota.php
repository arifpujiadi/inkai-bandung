...
<html lang="en">
    <head>
        ...
        <link href="../../css/custom/admin/lihatAnggota.css" rel="stylesheet">
    </head>
                                                    ...
                                                    <?php for ($i = 0; $i < 10; $i++) { ?>
                                                        <div class="boxOut-listAnggota">
                                                            <div class="col-md-12 col-sm-12 col-xs-12 hover-listAnggota">
                                                                ...
                                                                <a class="a-ubah hover-hitam font-Exo2SemiBold" href="lihatDetailAnggotaMSH.php">
                                                                    LIHAT PROFIL
                                                                </a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <?php for ($i = 0; $i < 10; $i++) { ?>
                                                        <div class="boxOut-listAnggota">
                                                            <div class="col-md-12 col-sm-12 col-xs-12 hover-listAnggota">
                                                                ...
                                                                <a class="a-ubah hover-coklat font-Exo2SemiBold" href="lihatDetailAnggotaKyu.php">
                                                                    LIHAT PROFIL
                                                                </a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <?php for ($i = 0; $i < 10; $i++) { ?>
                                                        <div class="boxOut-listAnggota">
                                                            <div class="col-md-12 col-sm-12 col-xs-12 hover-listAnggota">
                                                                ...
                                                                <a class="a-ubah hover-biru font-Exo2SemiBold" href="lihatDetailAnggotaKyu.php">
                                                                    LIHAT PROFIL
                                                                </a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <?php for ($i = 0; $i < 10; $i++) { ?>
                                                        <div class="boxOut-listAnggota">
                                                            <div class="col-md-12 col-sm-12 col-xs-12 hover-listAnggota">
                                                                ...
                                                                <a class="a-ubah hover-hijau font-Exo2SemiBold" href="lihatDetailAnggotaKyu.php">
                                                                    LIHAT PROFIL
                                                                </a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <?php for ($i = 0; $i < 10; $i++) { ?>
                                                        <div class="boxOut-listAnggota">
                                                            <div class="col-md-12 col-sm-12 col-xs-12 hover-listAnggota">
                                                                ...
                                                                <a class="a-ubah hover-kuning font-Exo2SemiBold" href="lihatDetailAnggotaKyu.php">
                                                                    LIHAT PROFIL
                                                                </a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <?php for ($i = 0; $i < 10; $i++) { ?>
                                                        <div class="boxOut-listAnggota">
                                                            <div class="col-md-12 col-sm-12 col-xs-12 hover-listAnggota">
                                                                ...
                                                                <a class="a-ubah hover-putih font-Exo2SemiBold" href="lihatDetailAnggotaKyu.php">
                                                                    LIHAT PROFIL
                                                                </a>
                                                            </div>
                                                        </div>
