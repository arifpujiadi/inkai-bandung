...
<html lang="en">
    <head>
        <title>Ubah Detail Anggota</title>
        <!--css-->
        <!--==================================================-->
        <?php include '_adminCss.php'; ?>
        <link href="../../css/custom/admin/ubahDetailAnggota.css" rel="stylesheet">
    </head>
                                                                            ...
                                                                            <div class="col-md-12 col-sm-12 col-xs-12 boxOut-listField">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                                                        ...
                                                                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                                                                            <div class="radio box-radio font-PoppinsLight">
                                                                                                <label><input type="radio" name="optJenisAnggota" checked>MSH</label>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <!-- /radio button jenis anggota -->
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-12 col-sm-12 col-xs-12 boxOut-listField">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                                                        <!-- Field nomor MSH -->
                                                                                        <input type="text" placeholder="" class="form-control field-text font-PoppinsLight" value="18866/1/2017">
                                                                                        <!-- /Field nomor MSH -->
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-12 col-sm-12 col-xs-12 boxOut-listField">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-12 col-sm-12 col-xs-12 boxOut-search">
                                                                                        <!-- Field option dojo -->
                                                                                        <input type="text" class="form-control field-text field-search font-PoppinsLight" placeholder="" list="listDojo" value="Parahyangan Karate Club">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                                                        ...
                                                                                        <select class="form-control dropdown-konfirmasiPembayaran font-PoppinsLight">
                                                                                            ...
                                                                                            <option value="" selected>Dan 1</option>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12 col-sm-12 col-xs-12 boxOut-listField">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                                                    <!-- Field nama lengkap -->
                                                                                    <input type="text" placeholder="" class="form-control field-text font-PoppinsLight" value="Mochamad Arif Pujiadi">
                                                                                    <!-- /Field nama lengkap -->
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                                    ...
                                                                                    <div class="col-md-12 col-sm-12 col-xs-12 boxOut-listField">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                                                                ...
                                                                                                <input type="text" placeholder="" class="form-control field-text font-PoppinsLight" value="Arif">
                                                                                                <!-- /Field nama panggilan -->
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-md-12 col-sm-12 col-xs-12 boxOut-listField">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                                                                ...
                                                                                                <div class="col-md-6 col-sm-6 col-xs-6">
                                                                                                    <div class="radio box-radio font-PoppinsLight">
                                                                                                        <label><input type="radio" name="optJenisKelaminDan" checked>Laki-laki</label>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <!-- /Radio button jenis kelamin -->
                                                                                            </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-12 col-sm-12 col-xs-12 boxOut-listField">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                                                                <!-- Field tempat lahir -->
                                                                                                <input type="text" placeholder="" class="form-control field-text font-PoppinsLight" value="Bandung">
                                                                                                <!-- /Field tempat lahir -->
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-12 col-sm-12 col-xs-12 boxOut-listField">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                                                                <!-- Field tanggal lahir -->
                                                                                                <input type="text" placeholder="DD / MM / YYYY" class="form-control field-text font-PoppinsLight center" data-inputmask="'mask': '99/99/9999'" value="06/02/1990">
                                                                                                <!-- /Field tanggal lahir -->
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12 col-sm-12 col-xs-12 boxOut-listField">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                                                    <!-- Field nomor kontak -->
                                                                                    <input type="text" placeholder="" class="form-control field-text font-PoppinsLight" value="085721498605" onkeydown="return (event.which >= 48 && event.which <= 57) || event.which == 8 || event.which == 46">
                                                                                    <!-- /Field nomor kontak -->
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12 col-sm-12 col-xs-12 boxOut-listField">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                                                    <!-- Field alamat rumah -->
                                                                                    <input type="text" placeholder="" class="form-control field-text font-PoppinsLight" value="Jl.Kismis No.7">
                                                                                    <!-- /Field alamat rumah -->
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                            ...
                                                                            <div class="col-md-4 col-sm-4 col-xs-12 boxOut-timeLeft-2">
                                                                                <div class="col-md-12 col-sm-12 col-xs-12 boxOut-listField">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                                                            <!-- Field tinggi badan -->
                                                                                            <input type="text" placeholder="Centimeter" class="form-control field-text font-PoppinsLight" value="178" onkeydown="return (event.which >= 48 && event.which <= 57) || event.which == 8 || event.which == 46" maxlength="3">
                                                                                            <!-- /Field tinggi badan -->
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="col-md-4 col-sm-4 col-xs-12 boxOut-timeRight-2">
                                                                                <div class="col-md-12 col-sm-12 col-xs-12 boxOut-listField">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                                                            <!-- Field berat badan -->
                                                                                            <input type="text" placeholder="Kilogram" class="form-control field-text font-PoppinsLight" value="70" onkeydown="return (event.which >= 48 && event.which <= 57) || event.which == 8 || event.which == 46" maxlength="3">
                                                                                            <!-- /Field berat badan -->
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12 col-sm-12 col-xs-12 boxOut-listField">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                                                    <!-- Field agama -->
                                                                                    <input type="text" placeholder="" class="form-control field-text font-PoppinsLight" value="Islam">
                                                                                    <!-- /Field agama -->
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12 col-sm-12 col-xs-12 boxOut-listField">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                                                    <!-- Field nama orangtua -->
                                                                                    <input type="text" placeholder="" class="form-control field-text font-PoppinsLight"  value="">
                                                                                    <!-- /Field nama orangtua -->
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-12 col-sm-12 col-xs-12 boxOut-listField">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                                                    ...
                                                                                    <input type="text" placeholder="" class="form-control field-text font-PoppinsLight"  value="" onkeydown="return (event.which >= 48 && event.which <= 57) || event.which == 8 || event.which == 46">
                                                                                    <!-- /Field nomor kontak ortu -->
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                                ...
                                                                                <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
                                                                                    <table class="col-md-12 col-sm-12 col-xs-12 boxOut-tambahJadwal edit-tableDan font-PoppinsLight">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="">
                                                                                                <div class="td-3">
                                                                                                    <input type="text" placeholder="Masukan nama & alamat tempat pelaksanaan ujian" class="form-control field-text font-PoppinsLight"  value="SMA PGII 1 Bandung, Jl. Panatayuda No.2">
                                                                                                </div>
                                                                                            </td>
                                                                                            <td class="">
                                                                                                <div class="td-4">
                                                                                            ...
                                                                                            <td class="">
                                                                                                <div class="td-7">
                                                                                                    <div class="checkbox td-checkbox">
                                                                                                        <label><input type="checkbox" class="" value="" disabled="" checked></label>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </td>
                                                                                            <td class="">
                                                                                ...
                                                                                <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
                                                                                    <table class="col-md-12 col-sm-12 col-xs-12 boxOut-tambahJadwal edit-tableDan font-PoppinsLight">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="">
                                                                                                <div class="td-3">
                                                                                                    <input type="text" placeholder="Masukan nama & alamat tempat pelaksanaan ujian" class="form-control field-text font-PoppinsLight" value="Hambalang Bogor, Jl. Gatau jalan apa No.666 ">
                                                                                                </div>
                                                                                            </td>
                                                                                            <td class="">
                                                                                                <div class="td-4">
